                                    ...
                                    .child(if is_maximized {
                                        ...
                                        div()
                                            ...
                                            .child(
                                                div()
                                                    .absolute()
                                                    .left(px(2.0)).top(px(0.0))
                                                    .w(px(9.0)).h(px(9.0))
                                                    .border_1().border_color(rgb(0xb8b3b0))
                                            )
                                            .child(
                                                div()
                                                    .absolute()
                                                    .left(px(0.0)).top(px(2.0))
                                                    .w(px(9.0)).h(px(9.0))
                                                    .bg(rgb(0x101010))
                                                    .border_1().border_color(rgb(0xb8b3b0))
                                            )
                    ...
                    .child(
                        ...
                        div()
                                ...
                                div()
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .rounded(px(8.0))
                                            .bg(rgb(0x050507))
                                            .border_1().border_color(rgb(0x3d3a39))
                                            .flex().justify_center().items_center()
                            ...
                            .child(
                                div()
                                    .flex().flex_col()
                                    .w_full().p(px(8.0)).gap(px(4.0))
                                    .child(
                                        div()
                                            .flex().items_center()
                                            .w_full().px(px(16.0)).py(px(12.0)).gap(px(16.0))
                                            .rounded(px(6.0))
                                            .bg(rgba(0x00d9921a))
                                            .child(div().text_sm().text_color(rgb(0x00d992)).child("控制台核心"))
                                    )
                                    .child(
                                        div()
                                            .flex().items_center()
                                            .w_full().px(px(16.0)).py(px(12.0)).gap(px(16.0))
                                            .rounded(px(6.0))
                                            .child(div().text_sm().text_color(rgb(0xb8b3b0)).child("组件插件库"))
                                    )
                            )
                            .child(div().flex_1())
                            .child(
                                div()
                                    ...
                                    .child(
                                        div()
                                            .flex().items_center()
                                            .w_full().p(px(12.0)).gap(px(8.0))
                                            .bg(rgb(0x050507)).rounded(px(6.0))
                                            .child(div().w(px(8.0)).h(px(8.0)).rounded_full().bg(rgb(0x00d992)))
                                            .child(div().text_sm().text_color(rgb(0xb8b3b0)).child("系统运行正常"))
                                    )
                            )
                    )
                    .child(
                                ...
                                div()
                                    ...
                                    .child(
                                        div()
                                            .flex().justify_between().items_center().w_full()
                                            .child(
                                                div().text_xl().text_color(rgb(0xf2f2f2)).child("已加载的独立窗口部件")
                                            )
                                            .child(
                                                div()
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .child(
                                                div()
                                                    .w(px(200.0)).h(px(120.0))
                                                    .bg(rgb(0x101010))
                                                    .border_1().border_color(rgb(0x3d3a39))
                                                    .rounded(px(8.0)).p(px(16.0))
