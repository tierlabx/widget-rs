...
- 将更新弹窗重构为独立窗口解决静默启动不可见问题

## [0.10.2](https://github.com/tierlabx/widget-rs/releases/tag/v0.10.2) - 2026-09-23

### Fixed

- 优化多显示器自适应与 GPUI DisplayId 目标屏幕定位
...
- 优化侧边栏标签交互与布局（自适应宽度/拖拽排序/向左浮动延伸）
- implement sticky note widget with pagination, theme support, and image drag-and-drop capability
...
- 将 src 平铺结构重构为 model/ui/settings/tests 子模块

## [0.8.0](https://github.com/tierlabx/widget-rs/releases/tag/v0.8.0) - 2026-09-04

### Added

- 升级至 gpui-kit 0.6.0 生态系统

### Fixed

- 修复透明背景bug

## [0.7.8](https://github.com/tierlabx/widget-rs/releases/tag/v0.7.8) - 2026-09-04

### Fixed

- 修复小组件置顶失效及无法立即升至顶层的问题
- 修复同宿主窗口Z序联动导致聚焦不独立

## [0.7.7](https://github.com/tierlabx/widget-rs/releases/tag/v0.7.7) - 2026-09-03

### Added

- 添加 Fences 插件的初始结构，包含 URL 书签模态框和系统实用工具

## [0.7.6](https://github.com/tierlabx/widget-rs/releases/tag/v0.7.6) - 2026-09-03
...
- 抽象通用设置弹窗组件、重构待办与休息提醒设置并修复Win+D桌面常驻与取消置顶逻辑
